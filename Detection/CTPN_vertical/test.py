...
if __name__=='__main__':
    ...
    drawRect(gtboxes,img1)
    print(np.array(img1).shape)
    img2=Image.fromarray(imgRotation)
    newbox=[]
    print(imgRotation.shape)
    for i in gtboxes:
        newbox.append((i[1],img1.size[0]-i[2],i[3],img1.size[0]-i[0]))
    drawRect(newbox,img2)

    # cv2.imwrite('img_rotate.jpg',imgRotation)
    # cv2.waitKey(0)