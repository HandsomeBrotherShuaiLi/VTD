...
from Detection.Proposed_Model.label import point_inside_of_quad
from Detection.Proposed_Model.network import East
from Detection.Proposed_Model.preprocess import resize_image
from Detection.Proposed_Model.nms import nms
